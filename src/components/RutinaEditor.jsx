...
export default function RutinaEditor({ rutinaInicial, titulo, onClose, onSave }) {
    ...
    const addSemana = () =>
        setRutina(r => {
            ...
            const nuevaSemana = {
                id: generateId(),
                nombre: `Semana ${r.semanas.length + 1}`,
                dias: ultimaSemana.dias.map(dia => ({
                    ...dia,
                    id: generateId(),
                    etapas: dia.etapas.map(etapa => ({
                        ...etapa,
                        ejercicios: etapa.ejercicios.map(ej => ({
                            ...ej,
                            id: generateId(),
                        })),
                    })),
            ...
            return { ...r, semanas: [...r.semanas, nuevaSemana] };
        });
